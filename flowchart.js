...
// console.log(output) ;
// 
// let unit = readlineSync.questionInt("enter the number unit ");
// let surcharge = 0;
// if(unit<=50){
//     electicitybill=unit*0.50
// }else if(unit<=150){
//     electicitybill = 50*0.50+(unit-50)*0.75
// }else if(unit<=250){
//     electicitybill = 50*0.50+ 100*0.75+ (unit-150)*1.20
// }else{
//     electicitybill = 50*0.50+100*0.75+ 100*1.20+(unit-250)*1.50
// }
// surcharge = (electicitybill*20/100)
// console.log(electicitybill+surcharge);
